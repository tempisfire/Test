...
local Themes = {
    ["Dark"] = {
        ...
        ItemUIStrokeSelected = Color3.fromRGB(242, 126, 184),
        ...
        SliderInner = Color3.fromRGB(242, 126, 184),
        ...
        ToggleInnerEnabled = Color3.fromRGB(242, 126, 184),
        ContainerHolder = Color3.fromRGB(26, 26, 31),
        HighlightUIStroke = Color3.fromRGB(79, 79, 86),
        Highlight = Color3.fromRGB(242, 126, 184)
    },
    ["Tokyo Night"] = {
...
if not isfolder("Unnamed") then
    ...
    local Shadow =
        request(
            { Url = "https://raw.githubusercontent.com/Rain-Design/Unnamed/main/Icons/UnnamedShadow.png", Method = "GET" }
        )
    writefile("Unnamed/Shadow.png", Shadow.Body)

    local Chevron =
        request({ Url = "https://raw.githubusercontent.com/Rain-Design/Unnamed/main/Icons/Chevron.png", Method = "GET" })
    writefile("Unnamed/Chevron.png", Chevron.Body)

    local Circle =
        request({ Url = "https://raw.githubusercontent.com/Rain-Design/Unnamed/main/Icons/Circle.png", Method = "GET" })
...
function library:Window(Info)
    ...
    closeButton.MouseEnter:Connect(
        function()
            TweenService:Create(
                closeButton,
                TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
    ...
    minimizeButton.MouseButton1Click:Connect(
        function()
            ...
            TweenService:Create(
                main,
                TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                { Size = Minimized and UDim2.new(0, 500, 0, 34) or UDim2.new(0, 500, 0, 350) }
            ):Play()
            ...
            function sectiontable:Slider(Info)
                ...
                dragButton.MouseButton1Down:Connect(function()
                    TweenService:Create(
                        sliderUIStroke,
                        TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                        { Color = Theme.ItemUIStrokeSelected }
                    ):Play()
                end)
                ...
                local MouseMoveConn, MouseKillConn
                ...
                local function setFromPx(Px)
                    ...
                    TweenService:Create(
                        dragIcon,
                        TweenInfo.new(0.09, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                        { Position = UDim2.new(iconpos, -5, 0, -2) }
                    ):Play()
                ...
                local function pxFromMouseX()
                    local absPos = sliderOuter.AbsolutePosition.X
                    local absSize = sliderOuter.AbsoluteSize.X
                    return (Mouse.X - absPos) / absSize
                end
                ...
                local function beginDrag()
                    ...
                    setFromPx(pxFromMouseX())

                    MouseMoveConn = Mouse.Move:Connect(function()
                        setFromPx(pxFromMouseX())
                    end)

                    MouseKillConn = UserInputService.InputEnded:Connect(function(UserInput)
                        if UserInput.UserInputType == Enum.UserInputType.MouseButton1 then
                            dragging = false
                            if MouseMoveConn then MouseMoveConn:Disconnect() end
                            if MouseKillConn then MouseKillConn:Disconnect() end
            ...
            function sectiontable:Dropdown(Info)
                ...
                function insidedropdown:Add(str)
                    ...
                    if DropdownOpened then
                        TweenService:Create(
                            ...
                            { Size = UDim2.new(0, 175, 0, section.Size.Y.Offset + 24) }
                        ):Play()
                        TweenService:Create(
                            sectionFrame,
                            TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                            { Size = UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset + 24) }
                        ):Play()
                        TweenService:Create(
                            itemContainer,
                            TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                            { Size = UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset + 24) }
                        ):Play()
                        TweenService:Create(
                            dropdown,
                            TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                            { Size = UDim2.new(0, 175, 0, dropdown.Size.Y.Offset + 24) }
                        ):Play()
                        TweenService:Create(
                            dropdownFrame,
                            TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                            { Size = UDim2.new(0, 171, 0, dropdownFrame.Size.Y.Offset + 24) }
                        ):Play()
                        TweenService:Create(
                            dropdownContainer,
                            TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                            { Size = UDim2.new(0, 171, 0, dropdownContainer.Size.Y.Offset + 24) }
                        ):Play()
                        task.wait(.1)
                    end
                    ...
                    dropdownElementButton.MouseButton1Click:Connect(
                        function()
                            ...
                            TweenService:Create(
                                ...
                                TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                {
                                    Size = DropdownOpened and UDim2.new(0, 175, 0, section.Size.Y.Offset + (DropdownY)) or
                                        UDim2.new(0, 175, 0, section.Size.Y.Offset - (DropdownY))
                                }
                            ):Play()
                            TweenService:Create(
                                sectionFrame,
                                TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                {
                                    Size = DropdownOpened and
                                        UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset + (DropdownY)) or
                                        UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset - (DropdownY))
                                }
                            ):Play()
                            TweenService:Create(
                                itemContainer,
                                ...
                                {
                                    Size = DropdownOpened and
                                        UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset + (DropdownY)) or
                                        UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset - (DropdownY))
                                }
                            ):Play()
                            TweenService:Create(
                                dropdown,
                                TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                {
                                    Size = DropdownOpened and UDim2.new(0, 175, 0, DropdownY + 28) or
                                        UDim2.new(0, 175, 0, 28)
                                }
                            ):Play()
                            TweenService:Create(
                                dropdownFrame,
                                TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                {
                                    Size = DropdownOpened and UDim2.new(0, 171, 0, DropdownY + 24) or
                                        UDim2.new(0, 171, 0, 24)
                                }
                            ):Play()
                            TweenService:Create(
                                dropdownContainer,
                                TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                { Size = DropdownOpened and UDim2.new(0, 171, 0, DropdownY) or UDim2.new(0, 171, 0, 0) }
                            ):Play()
                            TweenService:Create(
                                dropdownIcon,
                                TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                { Rotation = DropdownOpened and -90 or 90 }
                            ):Play()
                            dropdownIcon.Position =
                                DropdownOpened and UDim2.new(0, 156, 0, 5) or UDim2.new(0, 155, 0, 5)
                ...
                SectionOpened:GetPropertyChangedSignal("Value"):Connect(
                    function()
                        ...
                        dropdown.Size =
                            DropdownOpened and UDim2.new(0, 175, 0, DropdownY + 28) or UDim2.new(0, 175, 0, 28)
                        dropdownFrame.Size =
                            DropdownOpened and UDim2.new(0, 171, 0, DropdownY + 24) or UDim2.new(0, 171, 0, 24)
                        dropdownContainer.Size =
                            DropdownOpened and UDim2.new(0, 171, 0, DropdownY) or UDim2.new(0, 171, 0, 0)
                        section.Size =
                            DropdownOpened and UDim2.new(0, 175, 0, section.Size.Y.Offset + (DropdownY)) or
                            UDim2.new(0, 175, 0, section.Size.Y.Offset - (DropdownY))
                        sectionFrame.Size =
                            DropdownOpened and UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset + (DropdownY)) or
                            UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset - (DropdownY))
                        itemContainer.Size =
                            DropdownOpened and UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset + (DropdownY)) or
                            UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset - (DropdownY))
                ...
                dropdownTextButton.MouseButton1Click:Connect(
                    function()
                        ...
                        TweenService:Create(
                            ...
                            TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                            {
                                Size = DropdownOpened and UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset + (DropdownY)) or
                                    UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset - (DropdownY))
                            }
                        ):Play()
                        TweenService:Create(
                        ...
                        TweenService:Create(
                            dropdown,
                            TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                            { Size = DropdownOpened and UDim2.new(0, 175, 0, DropdownY + 28) or UDim2.new(0, 175, 0, 28) }
                        ):Play()
                        TweenService:Create(
                            dropdownFrame,
                            TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                            { Size = DropdownOpened and UDim2.new(0, 171, 0, DropdownY + 24) or UDim2.new(0, 171, 0, 24) }
                        ):Play()
                        TweenService:Create(
                            dropdownContainer,
                            TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
            ...
            function sectiontable:Toggle(Info)
                ...
                toggleTextButton.MouseButton1Down:Connect(
                    function()
                        TweenService:Create(
                            toggleUIStroke,
                            TweenInfo.new(.13, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                            { Color = Theme.ItemUIStrokeSelected }
                        ):Play()
                    end
                )
                ...
                function toggletable:Set(bool)
                    ...
                    TweenService:Create(
                        toggleOuter,
                        TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                        { BackgroundColor3 = bool and Theme.ToggleOuterEnabled or Theme.ToggleOuter }
                    ):Play()
                    TweenService:Create(
                        toggleInner,
                        TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                        { ImageColor3 = bool and Theme.ToggleInnerEnabled or Theme.ToggleInner }
                    ):Play()
                    TweenService:Create(
                        toggleInner,
                        TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                        { Position = bool and UDim2.new(0, 18, 0, 2) or UDim2.new(0, 2, 0, 2) }
                    ):Play()
                    TweenService:Create(
                        toggleOuterUIStroke,
                        TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
                        { Color = bool and Theme.ToggleOuterUIStrokeEnabled or Theme.ToggleOuterUIStroke }
                    ):Play()
